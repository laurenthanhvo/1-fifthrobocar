...
# ============================================================
# Final revert to original RGB lane + obstacle setup
# ============================================================

# RGB-only camera and lane follower.
CV_CONTROLLER_INPUTS = ["cam/image_array"]
CV_CONTROLLER_OUTPUTS = ["pilot/steering", "pilot/throttle", "cv/image_array"]
CV_CONTROLLER_MODULE = "lane_center_follower"
CV_CONTROLLER_CLASS = "LaneCenterFollower"
...
# Disable depth / heatmap / size detection experiments.
DEPTH_VIEW_MODE = "off"
DEPTH_OBSTACLE_ENABLE = False
YOLO_OBSTACLE_ENABLE = False
OBSTACLE_AVOIDANCE_ENABLE = False
...
# Camera setup from the working version.
CAMERA_TYPE = "OAKD"
IMAGE_W = 640
IMAGE_H = 400
IMAGE_DEPTH = 3
...
# ============================================================
# RESTORE: good RGB bird's-eye lane + original obstacle stop view
# ============================================================

# RGB-only camera / original CV controller.
CV_CONTROLLER_INPUTS = ["cam/image_array"]
CV_CONTROLLER_OUTPUTS = ["pilot/steering", "pilot/throttle", "cv/image_array"]
CV_CONTROLLER_MODULE = "lane_center_follower"
CV_CONTROLLER_CLASS = "LaneCenterFollower"
...
# Disable all depth / heatmap / YOLO / lidar experiments.
DEPTH_VIEW_MODE = "off"
DEPTH_OBSTACLE_ENABLE = False
YOLO_OBSTACLE_ENABLE = False
OBSTACLE_AVOIDANCE_ENABLE = False
...
# Camera back to previous working view.
CAMERA_TYPE = "OAKD"
IMAGE_W = 640
IMAGE_H = 400
IMAGE_DEPTH = 3
...
# ============================================================
# Bird's-eye view restore
# ============================================================

LANE_USE_BIRDSEYE = True

# Conservative trapezoid: only warp the floor/lane area, not the whole room.
# This should remove the horrible stretched desk/person/background effect.
LANE_BIRD_SRC_BOTTOM_LEFT = (0.05, 0.98)
LANE_BIRD_SRC_BOTTOM_RIGHT = (0.95, 0.98)
LANE_BIRD_SRC_TOP_LEFT = (0.34, 0.62)
LANE_BIRD_SRC_TOP_RIGHT = (0.66, 0.62)
...
# Only scan the lower track region after bird's-eye.
LANE_ROI_Y_START = 0.52
LANE_ROI_Y_END = 1.00
LANE_LOOKAHEAD_Y_FRACTION = 0.62
LANE_NUM_BANDS = 12
...
# ============================================================
# Lane color / noise restore
# ============================================================

# Yellow tape detection.
LANE_HSV_LOW = (18, 100, 100)
LANE_HSV_HIGH = (32, 255, 255)
...
# ============================================================
# Steering / path-following restore
# ============================================================
...
# ============================================================
# Original color-based obstacle stop restore
# ============================================================

OBSTACLE_ENABLE = True

# Red/orange obstacle detection only.
# This removes the huge false boxes from dark monitors/people/chairs.
...
# More conservative bird's-eye: use even less of the far background
LANE_BIRD_SRC_TOP_LEFT = (0.38, 0.68)
LANE_BIRD_SRC_TOP_RIGHT = (0.62, 0.68)
