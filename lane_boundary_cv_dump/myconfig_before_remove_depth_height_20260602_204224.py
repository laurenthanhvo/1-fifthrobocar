...
# ============================================================
# OAK-D depth view / obstacle size visualization
# ============================================================

# Camera now outputs RGB + depth + heatmap.
...
# DonkeyCar web UI depth visualization mode:
#   "off"        = normal lane debug view
#   "depth_only" = raw camera + depth heatmap + obstacle box/size text
#   "overlay"    = lane debug view + depth heatmap overlay
DEPTH_VIEW_MODE = "depth_only"

DEPTH_OBSTACLE_ENABLE = True

# Depth range to consider as an obstacle, in millimeters.
DEPTH_OBSTACLE_MIN_MM = 150
DEPTH_OBSTACLE_MAX_MM = 1800

# Stop distance from the camera, in millimeters.
# If the camera is behind the bumper, use ~400 mm for bumper stopping ~1 foot away.
DEPTH_STOP_DISTANCE_MM = 400

# Ignore tiny depth blobs.
DEPTH_MIN_OBSTACLE_AREA = 700

# Search region for obstacles.
DEPTH_ROI_Y_START = 0.20
DEPTH_ROI_Y_END = 1.00
DEPTH_CENTER_CORRIDOR_HALF_WIDTH_PX = 220

# Camera intrinsics estimate for 640x400.
# Used for approximate physical width/height.
DEPTH_FX_PX = 287.82
DEPTH_FY_PX = 287.82

# Draw heatmap transparency.
DEPTH_HEATMAP_ALPHA = 0.45

# Require a few frames before stopping.
DEPTH_CONFIRM_FRAMES = 2

# ============================================================
# Fix depth camera stream wiring
# ============================================================

# OakCameraDepth returns RGB + raw depth only.
# Heatmap is generated inside lane_center_follower.py.
CV_CONTROLLER_INPUTS = [
    "cam/image_array",
    "cam/depth_array",
]
...
# Show depth view in DonkeyCar web UI.
DEPTH_VIEW_MODE = "depth_only"
DEPTH_OBSTACLE_ENABLE = True
